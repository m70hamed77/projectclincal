...
export default function StudentDashboard() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Navigation user={user ? { id: user.id, name: user.name || 'مستخدم', email: user.email || '', role: (user.role || 'STUDENT') as "PATIENT" | "STUDENT" | "ADMIN", avatar: user.avatarUrl ?? undefined } : undefined} />
