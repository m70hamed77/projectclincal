...
export async function POST(
  ...
  try {
    ...
    console.log('[ACCEPT API] Post ID:', id)
    console.log('[ACCEPT API] Application ID:', applicationId)

    if (!id || !applicationId) {
      console.log('[ACCEPT API] ❌ Missing IDs')
    ...
    console.log('[ACCEPT API] User ID from cookie:', userId)

    if (!userId) {
      console.log('[ACCEPT API] ❌ No user ID')
      return NextResponse.json(
    ...
    console.log('[ACCEPT API] Post found:', !!post)

    if (!post) {
      console.log('[ACCEPT API] ❌ Post not found')
      return NextResponse.json(
